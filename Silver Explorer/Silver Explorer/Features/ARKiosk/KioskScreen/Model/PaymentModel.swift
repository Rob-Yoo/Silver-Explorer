...
struct PaymentModel {
    ...
    static let paymentModalTitle: [PaymentType: String] = [
        .creditCard: "신용카드 결제",
        .barcode: "할인/바코드 결제"
    ]
    
    static let paymentDescriptionImages: [PaymentType: UIImage] = [
        .creditCard: #imageLiteral(resourceName: "creditPaymentImg"),
        .barcode: #imageLiteral(resourceName: "barcodePaymentImg")
    ]
    
    static let paymentDescriptionText: [PaymentType: String] = [
